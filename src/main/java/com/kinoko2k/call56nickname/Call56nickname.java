...
public final class Call56nickname extends JavaPlugin implements TabCompleter {
    // nick.yml
    ...
    public void onEnable(){
        ...
        pm.registerEvents(new Call56Listener(this), this);
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (cmd.getName().equals("nick")) {
            ...
            } else if(sender.hasPermission("call56.nick")){
